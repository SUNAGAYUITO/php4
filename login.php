...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($email !== "" && $password !== "") {
        // ユーザー検索
        $stmt = $pdo->prepare("SELECT * FROM sns_users WHERE email = :email");
...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="card-shadow p-8 rounded-3xl w-full max-w-md">
        ...
        <h2 class="text-2xl font-bold mb-6 text-center">おかえりなさい</h2>
        ...
        <div class="text-center mt-6 pt-6" style="border-top: 1px solid var(--border-color);">
            <p class="text-sm mb-2" style="color: var(--text-secondary);">まだココベースのメンバーではありませんか？</p>
            <a href="register.php" class="font-medium" style="color: var(--text-primary);">新しい仲間になる</a>
        </div>
    </div>
